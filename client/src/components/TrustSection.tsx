          ...
          {points.map((point, index) => (
            ...
            >
              <div className="flex justify-center">
                <div className="w-14 h-14 rounded-full bg-[#8B6F47]/10 flex items-center justify-center">
                  <point.icon className="text-[#8B6F47]" size={28} />
                </div>
              </div>
              <h3 className="font-['Poppins'] font-semibold text-[#1A1410]">
                {point.title}
              </h3>
