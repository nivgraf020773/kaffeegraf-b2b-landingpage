...
const products = [
  {
    ...
    specs: [
      ...
      { label: "Profil", value: "Schokolade · Nuss · Karamell" },
    ],
    badge: "Bestseller",
    highlight: true,
  },
  {
    ...
    specs: [
      ...
      { label: "Röstgrad", value: "Medium-Light" },
      { label: "Profil", value: "Frucht · Blume · Honig" },
    ],
    badge: null,
    highlight: false,
  },
  {
    ...
    specs: [
      ...
      { label: "Röstgrad", value: "Light-Medium" },
      { label: "Profil", value: "Zitrus · Karamell · Jasmin" },
    ],
    badge: "Premium",
    highlight: false,
  },
